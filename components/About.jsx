export default function About() {
    return (
        <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20" id="about">
            ...
            <div class="grid max-w-screen-lg gap-8 row-gap-10 mx-auto lg:grid-cols-2" data-aos="zoom-in" data-aos-duration="500" data-aos-easing="ease-in-back" >
                <div class="flex flex-col max-w-md sm:mx-auto sm:flex-row">
                    ...
                    <div>
                        <h6 class="mb-3 text-xl font-bold leading-5">Inclusion</h6>
                ...
                <div class="flex flex-col max-w-md sm:mx-auto sm:flex-row">
                    <div class="mr-4">
                        <div class="flex items-center justify-center w-12 h-12 mb-4 rounded-full bg-indigo-50">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-deep-purple-accent-400">
                    ...
                    <div>
                        <h6 class="mb-3 text-xl font-bold leading-5">Smart Token Creation System</h6>
                        <p class="mb-3 text-sm text-gray-900">
                ...
                <div class="flex flex-col max-w-md sm:mx-auto sm:flex-row">
                    ...
                    <div>
                        <h6 class="mb-3 text-xl font-bold leading-5">Innovative LaunchPad & Gamification</h6>
                        <p class="mb-3 text-sm text-gray-900">
                ...
                <div class="flex flex-col max-w-md sm:mx-auto sm:flex-row">
                    ...
                    <div>
                        <h6 class="mb-3 text-xl font-bold leading-5">0 Fees Base Currency Launchpad</h6>
                        <p class="mb-3 text-sm text-gray-900">
