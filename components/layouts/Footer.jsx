                ...
                <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div class="flex">
                            ...
                            <a href="tel:+44 (01736) (761830)" aria-label="Our phone" title="Our phone" class="transition-colors duration-300 text-white hover:text-gray-300">+44 (01736) (761830)</a>
                        </div>
                        <div class="flex">
                            <p class="mr-1  text-white">Email:</p>
                            <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" class="transition-colors duration-300 text-white hover:text-gray-300">contact@solderse.com</a>
                        </div>
                        <div class="flex">
                            <p class="mr-1  text-white">Address:</p>
                            <a href="https://www.google.com/maps" target="_blank" rel="noopener noreferrer" aria-label="Our address" title="Our address" class="transition-colors duration-300  text-white hover:text-gray-300">
                    ...
                    <div>
                        ...
                        <div class="flex items-center mt-1 space-x-3">
                            ...
                            <a href="/" class=" text-white transition-colors duration-300 hover:text-gray-200">
