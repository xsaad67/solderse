...
contract Presale is ReentrancyGuard, Context, Ownable {
    ...
    function startICO() external onlyOwner icoNotActive {
        //These can be passed as a function argument later on
        uint endDate = block.timestamp + 12 hours;
        uint _minPurchase = 100000000000000000;
        uint _maxPurchase = 2 ether;
        uint _softCap = 2 ether;
        uint _hardCap = 200 ether;
        //End
    ...
    /// Needs to be changed needs to be transfered to the person who have bought ico
